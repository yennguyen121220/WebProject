<?php
    class HoaDonModel extends DB{
        ...
        public function getAllList_HoaDon(){
            ...
            $qr="SELECT hd.mahd, makh, COUNT(masp) AS 'Số sp đã mua', tien, ngayhd, tinhtrang FROM hoadon hd, cthd ct WHERE hd.mahd=ct.mahd GROUP BY ct.mahd";
        ...
        public function getCTHD($id) {
            ...
            $qr2="SELECT ct.masp, tensp, gia, ct.soluong, thanhtien FROM cthd ct, sanpham sp WHERE ct.masp=sp.masp AND ct.mahd={$id}";
